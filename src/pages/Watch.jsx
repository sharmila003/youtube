...
import { BsThreeDotsVertical } from 'react-icons/bs'; // Import vertical three dots icon
...
function Watch() {
  ...
  const handleSaveToWatchLater = () => {
    navigate('/watch-later'); // Navigate to watch later page
  };
          ...
          <div className="flex items-center ml-2 space-x-2 relative">
            ...
            {showDropdown && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-1">
                ...
                <div className="flex items-center cursor-pointer px-4 py-2 hover:bg-gray-100" onClick={handleSaveToWatchLater}>
...
function Watch() {
  ...
  const handleSaveToWatchLater = () => {
    if (!isLoggedIn) {
      ...
      // Logic to save video to watch later list goes here
      console.log('Video added to Watch Later list');
      // Optionally, you can also close the dropdown here
